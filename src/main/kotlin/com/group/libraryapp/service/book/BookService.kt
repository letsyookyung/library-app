...
import com.group.libraryapp.repository.book.user.loanhistory.UserLoanHistoryQuerydslRepository
...
//        val book = bookRepository.findByName(request.bookName).orElseThrow(::IllegalArgumentException) // 아래거와 같은 것
        ...
        if (userLoanHistoryQuerydslRepository.find(request.bookName, UserLoanStatus.LOANED) != null) { // tip 바꿔서 하면 왜 안되나?
